...
class Worker:
    """ This is the base class of an Employee and a Contractor """
...
class Employee(Worker):
    """ This class represents a salaried worker, eg:  An employee. """
...
class Contractor(Worker):
    """ This class represents a contracted worker, with an hourly salary. """
...
class Task:
    """ A task is a unit of work that is usually part of a project.
    More than one task can be assigned into a project. """
...
class Project:
    """ This class represents the main project, which holds between 0 and n tasks. """
